...
const signupSchema = z.object({
    ...
    phone: z.string({ required_error: "Phone number is required" }).trim().min(10, "Phone must be atleast 10 characters long").max(25, "Password cannot be more than 25 character long"),
});
